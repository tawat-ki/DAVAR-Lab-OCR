...
RUN git checkout d6d38f5

WORKDIR /app/DAVAR-Lab-OCR/davarocr
...
WORKDIR /app/DAVAR-Lab-OCR/davarocr/davarocr/davar_rcg/third_party/warp-ctc-pytorch_bindings/
...
WORKDIR /app/DAVAR-Lab-OCR/davarocr/davarocr/davar_rcg/third_party/warp-ctc-pytorch_bindings/src
RUN rm ctc_entrypoint.cu
RUN ln -s ctc_entrypoint.cpp ctc_entrypoint.cu
WORKDIR /app/DAVAR-Lab-OCR/davarocr/davarocr/davar_rcg/third_party/warp-ctc-pytorch_bindings/
RUN mkdir build;
WORKDIR /app/DAVAR-Lab-OCR/davarocr/davarocr/davar_rcg/third_party/warp-ctc-pytorch_bindings/build
RUN cmake ..
RUN make

COPY ./davarocr/davarocr/davar_rcg/third_party/warp-ctc-pytorch_bindings/pytorch_binding/setup.py /app/DAVAR-Lab-OCR/davarocr/davarocr/davar_rcg/third_party/warp-ctc-pytorch_bindings/pytorch_binding
WORKDIR /app/DAVAR-Lab-OCR/davarocr/davarocr/davar_rcg/third_party/warp-ctc-pytorch_bindings/pytorch_binding
